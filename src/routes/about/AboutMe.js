  ...
  return (
    <section>
      ...
      <p className="white-text p-tag">
        I am a front-end web developer with 1 years of working experience in
        fields like management,web Development and teaching. I
        ...
        responsive websites using HTML, CSS, MongoDB, Sass, Node, Express
